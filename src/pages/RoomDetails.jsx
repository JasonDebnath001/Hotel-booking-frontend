    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex items-center gap-1 text-gray-500 mt-2">
          <img src={assets.locationIcon} alt="Address" className="" />
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          ...
          {/* room price */}
          <p className="text-2xl font-medium">CA${room.pricePerNight}/Night</p>
        </div>
        ...
        <div className="mt-25 space-y-4">
          {roomCommonData.map((spec, index) => (
            <div key={index} className="flex items-start gap-2">
              <img src={spec.icon} alt="Specs" className="w-6.5" />
              <div>
        ...
        <div className="flex flex-col items-start gap-4">
          <div className="flex gap-4">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoJ8QQ2TFTO6doKjmht073A_hA0Jz8QvpGjg&s"
              alt="Owner"
